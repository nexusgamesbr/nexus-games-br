...
✨ Funcionalidades
Catálogo de jogos organizados por categorias.

Sistema de busca para encontrar rapidamente seus jogos favoritos.

Interface moderna e intuitiva, adaptada para desktop e mobile.

Possibilidade de adicionar novos jogos facilmente.
...
Frameworks e bibliotecas adicionais (dependendo da implementação).
